...
# For Training
tk.Label(root, text="Training the Model", font='customFont1', fg="black", bg="sky blue", width=15).grid(columnspan=1,
                                                                                                        row=0, column=0)
...
tk.Label(root, text="Path for Training the Model : ", font='customFont1', fg="black", width=20).grid(columnspan=1,
                                                                                                     row=1, column=0)
training_path = tk.Entry(root, width=60, textvariable=folder_path).grid(row=1, column=1)

browseBtn = tk.Button(root, text="Browse Folder", command=lambda: browse_folder(), font='customFont1', bg="azure",
...
tk.Label(root, text="Accuracy obtained after validating the model with 20% of training data : ", font='customFont1',
         fg="black", width=40, wraplength=250).grid(columnspan=1, row=4, column=0)
...
def main():
    ...
    classifier = MLPClassifier(hidden_layer_sizes=(100, 50, 50), max_iter=300, activation='relu', solver='adam',
                               random_state=1)
...
trainBtn = tk.Button(root, text="Train", command=lambda: main(), font='customFont1', bg="azure", fg="black", height=3,
                     width=15)
...
tk.Label(root, text="Path for Testing the Model : ", font='customFont1', fg="black", width=20).grid(columnspan=1, row=6,
                                                                                                    column=0)
...
browseOFileBtn = tk.Button(root, text="Browse Output Folder", command=lambda: browse_outputFile(), font='customFont1',
                           bg="azure", fg="black", height=2, width=15)
